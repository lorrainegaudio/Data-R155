...
```{r eval=FALSE, include=FALSE}
n_manual <- nrow(marshmallows_only)  # ✅ Check number of rows
...
Setup: Load the built‑in data set and take a quick look. Identify what the columns contain and meaning of that content.
