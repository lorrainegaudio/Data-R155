...
1. For those of you who **have GitHub** and a course project, navigate to your course folder and open your course project. This will open RStudio. Click "Pull" in the Git pane to get the latest version of the course materials. If you **don't have GitHub** or a course project, just open RStudio and set your working directory to your course folder.
...
In dplyr, `filter()` keeps rows based on values, while `select()` keeps columns based on names or selection helpers.
...
📦 Make sure `dplyr` and `dslabs` packages are library'd so their functions / datasets load.
