...
Frame the chapter around one repeatable habit: Ask → Load → Verify → Explore → Document.
...
2. Required student habit: rename the file once, early, using a clear convention (e.g., chapter5_survey_raw.csv).
