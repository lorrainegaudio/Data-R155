...
mean(Vector_NA, trim = 0.2, na.rm = TRUE)  # drop 20% from each end first
```
...
1. You will be submitting **both** the R Notebook (RMD) and the workspace file. The workspace file saves all the objects in your environment that you created in this lesson. You can save the workspace (RData) by clicking the "Save Workspace" button in the Environment pane. 
