...
- 🔨 Build and inspect vectors: numeric, integer, logical, and character
- 🔧 Use logical operators to create logical vectors
- 🪄 Convert a character vector into factor class
- 💪 Practice reproducible work by fixing errors and documenting what happened
...
A logical vector can be created several ways. For this task, you will create the vector using **logical operators**.

___

📖 **Review** The logical operators are:
