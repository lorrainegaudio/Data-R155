...
In Chapter 3, you will switch from writing in an R Script to working in an R Notebook (`.Rmd`), where your notes, code, and output live together in one document. In this course, the main advantage of an R Notebook is that it makes memoing easier: you can write full paragraphs between code chunks (instead of turning everything into `#` comments). You will learn how to create and save a notebook, edit the YAML header (the document settings), run code chunks, and then practice core vector skills—vector arithmetic, recycling, coercion, indexing, and basic data types—while documenting your process transparently.
