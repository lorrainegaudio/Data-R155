...
🗣 The output shows the updated `rainbow` vector with "indigo" added to the end.
...
```{r , eval=FALSE}
# ⚡ Type this in your R Script, Fill in the blanks
______ <- _("#7F00FF", "#003B6F", "#663399", "#4F97A3", "#FFF8E7", "#000000", "#03A062", "#FF00FF", "#CC0000")
```
...
🗣 Comment: # The output shows the updated `nerdy_palette` vector with "#4D9E68" added to the end.
