...
```{r graded-activity, echo=FALSE, message=FALSE, warning=FALSE}
library(tibble)
library(knitr)
library(kableExtra)
...
k <- if (is_html) {
  k |>
    ...
    # Use %/em widths for HTML and force wrapping for long text
    column_spec(1, width = "22%", extra_css = "word-break: break-word;") |>
    column_spec(2, width = "10%") |>
    column_spec(3, width = "68%", extra_css = "word-break: break-word;") |>
...
```{r grade-bands, echo=FALSE, message=FALSE, warning=FALSE}
library(tibble)
library(knitr)
library(kableExtra)
...
k <- if (is_html) {
  k |>
    ...
    column_spec(2, width = "26%", extra_css = "word-break: break-word;") |>
    column_spec(3, width = "26%", extra_css = "word-break: break-word;") |>
    column_spec(4, width = "26%", extra_css = "word-break: break-word;") |>
    row_spec(0, bold = TRUE)
} else {
  k |>
